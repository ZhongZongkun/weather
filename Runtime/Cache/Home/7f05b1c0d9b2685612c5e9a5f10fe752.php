...
<div id="content1">
	<div class="header">
		...
		<span style="float: left;font-family: '微软雅黑';font-weight: 500; text-align: center; margin-top: -3px; font-size: 18px;margin-left: 50px;"><span class="glyphicon glyphicon-home" aria-hidden="true"><p style="display: inline-block; height: 40px; margin-left: 10px;">人员信息管理</p></span></span>
	 ...
	 <div id="item1" class="item">
        ...
        <table class="table table-hover table-bordered" style="background:rgb(237, 239, 224) ">
		  ...
		  <?php if(is_array($people)): foreach($people as $key=>$v): ?><tr>
			  ...
			  <td class="eq_tilte"><button data-toggle="modal" data-target="#allmessage" class="btn btn-primary show_btn">详细信息</button></td>
				    ...
				    <div class="modal-content">
				      ...
				      <div class="modal-body">
				      		<form action="<?php echo U('handle');?>" name='wish' style="padding-left: 17px;" method="post">
				      			...
				      			出生年月：<input type="date" name="birthday" style="width:220px;"></input><br>
				      			...
				      			毕业时间：<input style="width:180px;" name="graduatetime" type="date"></input><br>
				      			...
				      			执照取得时间：<input type="date" name="licensetime" style="width:170px;"></input><br>
				      			职称：<input type="text" name="zhicheng" style="width:220px;"></input><br>
				      			职称取得时间：<input type="date" name="zhichengtime" style="width:220px;"></input><br>
				      			专业岗位工作起始时间：<input type="date" name="worktime" style="width:220px;"></input><br>
				      			学习方式：<input type="text"  name="learnmethod" style="width:170px;"></input><br>
				      			最高学位取得时间：<input type="date" name="largedegreetime" style="width:220px;"></input><br>
				      			执照注册时间：<input type="date" name="licenseregisttime"></input><br>
				      			...
				      			岗前培训时间：<input type="text"></input><br><br>
				      			<span>备注：</span><br>
				      			<textarea name="others"  style="width: 400px; margin-left: 50px; margin-top: -30px; margin-bottom: 20px; height: 100px;">111</textarea>
