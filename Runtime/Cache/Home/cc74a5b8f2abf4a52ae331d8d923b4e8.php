...
<div class="yb_content">
	...
	<table class="table table-hover" id="reports_form" style="background:rgb(242, 242, 242); width: 90%; margin: 20px auto;">
			<?php if(is_array($info1)): foreach($info1 as $key=>$v): ?><tr>
		  	<td class="eq_tilte" style="width:75%;line-height:30px;"><a href="###" report='<?php echo ($v["id"]); ?>' data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo"> <?php echo ($v["name"]); ?></a></td>
		  	<td class="eq_tilte" style="width:100%;float:right;line-height:29px;"><?php echo (date('Ymd',$v["time"])); ?></td>
		  	<td>
