		...
		<div class="landing-content">
			...
			<div class="landing-content-bottom">
				...
				<div class="form-group1">
				    <input name="email" type="text" class="form-control" style="background:  url('<?php echo (SITE_URL); ?>public/images/int.png') 3px 3px  no-repeat; color: #FFF; height: 40px; padding-left: 30px; border-radius: 10px; ">
				  </div>
